...
public class SpecificationServiceImpl implements SpecificationService{
    ...
    public SpecificationDTO addSpecification(AddSpecificationRequest request) {
        ...
        if (productDTO == null) {
            throw new UnprocessableException(Constants.NOT_FOUND,"Cannot find this product to create new Specification");
        }
    ...
    public SpecificationDTO updateSpecification(UpdateSpecificationRequest request) {
        ProductDTO productDTO = productService.getProductInfo(request.getProductId());
        if (productDTO == null) {
            throw new UnprocessableException(Constants.NOT_FOUND,"Cannot find this product to update this Specification");
        }
